...
func (s *fokusBelanjaService) CountJumlahFokusBelanja(tahun, tipe string) (int64, error) {
	var jumlahFokusBelanja, err = s.fokusBelanjaRepository.CountJumlahFokusBelanja(tahun, tipe)
